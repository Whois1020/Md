...
handler.all = async function (m) {
  ...
  global.namechannel = '⏤͟͞㋡ Arceus Whois  ⚡ '
  global.namegrupo = ' Arceus Whois ☘︎'
  global.namecomu = '𝗖𝗼𝗺𝘂𝗻𝗶𝗱𝗮𝗱 ⏤͟͞ Arceus Whois  ⚡ '
  global.listo = '⚔️ *Aquí tienes perra*'

  //Ids channel
  global.canalIdM = ["120363419947391620@newsletter", "120363419947391620@newsletter"]
  global.canalNombreM = ["⏤͟͞㋡ Arceus Whois  ⚡ ", "㋡ Arceus Whois  ⚡ "]
  ...
  global.rcanal = { contextInfo: { isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, serverMessageId: 100, newsletterName: channelRD.name }, externalAdReply: { showAdAttribution: true, title: "Arceus Whois ☘", body: "Whois", mediaUrl: null, description: null, previewType: "PHOTO", thumbnailUrl: icono, sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false }, } }
